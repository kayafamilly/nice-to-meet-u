  ...
  return (
    <main>
      ...
      <section className="shell hero">
        ...
        <div className="conversation-stage" aria-label="Illustration of a small online language practice group">
          <span className="floating-word one">Hola, que tal?</span><span className="floating-word two">Nice to meet you 👋</span>
          <div className="conversation-grid">
            <div className="conversation-face"><Image src="/people/maya-language-session.png" alt="" fill sizes="(max-width: 900px) 45vw, 22vw" priority /></div>
            <div className="conversation-face"><Image src="/people/kenji-language-session.png" alt="" fill sizes="(max-width: 900px) 45vw, 22vw" priority /></div>
            <div className="conversation-face"><Image src="/people/amina-language-session.png" alt="" fill sizes="(max-width: 900px) 45vw, 22vw" /></div>
            <div className="conversation-face"><Image src="/people/ben-language-session.png" alt="" fill sizes="(max-width: 900px) 45vw, 22vw" /></div>
          </div>
        </div>
      </section>
