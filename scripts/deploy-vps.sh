...
: "${MANAGEMENT_PASSWORD_HASH:?MANAGEMENT_PASSWORD_HASH is required}"
: "${MANAGEMENT_SESSION_SECRET:?MANAGEMENT_SESSION_SECRET is required}"
: "${MANAGEMENT_INTERNAL_SECRET:?MANAGEMENT_INTERNAL_SECRET is required}"
: "${ANALYTICS_HASH_SECRET:?ANALYTICS_HASH_SECRET is required}"
